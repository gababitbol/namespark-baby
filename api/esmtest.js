/* =============================================================
   Fonction de TEST minimale — valide en production les mécanismes
   dont /api/generate a besoin, sans recourir a la syntaxe ESM non transpilable :
     1. chargement du module lui-même (compilé ESM -> CommonJS) ;
     2. import d'un module voisin _prefixé (convention _helpers.js) ;
     3. lecture d'un fichier JSON embarqué via functions.includeFiles,
        chemin résolu avec process.cwd() (et NON la meta-URL du module, qui
        n'a pas d'équivalent CommonJS et fait échouer la compilation).
   À supprimer une fois /api/generate validé.
   ============================================================= */
import fs from "fs";
